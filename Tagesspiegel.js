// ==UserScript==
// @name TS-PaidContent-be-gone
// @namespace Violentmonkey Scripts
// @match https://www.tagesspiegel.de/
// @grant none
// @description Das Script erkennt Paid-Content-Blöcke des TS-Online-Auftrittes und 'deaktiviert' diese Blöcke / Links. 
// @grant unsafeWindow
// ==/UserScript==
//
...
`;
const main = () => {
  let PC_els = document.querySelectorAll('[href*="checkpoint.tagesspiegel"]')
  ;
  ...
  if( blocked_articles > 0 ) {
    ...
    PC_els.forEach( (el, n) => {
      ...
      let wrapper = el.closest('[class="newsletter"]')
      ;
    ...
    //
    trace('[FF] TS-PaidContent-be-gone')
    ;
  }
}
;
